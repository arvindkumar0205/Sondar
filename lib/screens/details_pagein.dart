      ...
      child: SafeArea(
        child: Padding(
          ...
          child:
            ...
            TextButton(onPressed: () {}, child: const Text("The Henry")),
            TextButton(onPressed: () {}, child: const Text("Bayswater,london")),
            SizedBox(
              height: h * 0.02,
            ),
            Row(
            ...
            TextButton(onPressed: () {}, child: const Text("Chelsea Green")),
            TextButton(onPressed: () {}, child: const Text("Chelsea, London")),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                ElevatedButton(
            ...
            TextButton(
                onPressed: () {}, child: Text("ROOM TYPES &NIGHTLY RATES")),
